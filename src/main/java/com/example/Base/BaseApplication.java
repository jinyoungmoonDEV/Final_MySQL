...
public class BaseApplication {
	...
	CommandLineRunner run(UserService userService) {
		return args -> {
//
//			userService.saveUser(new UserDTO(null , "user", 20, 3, "user@gmail.com","편의점 알바","1234","a","b","c",1.1,2,3,"ROLE_USER"));
...
//
//			userService.saveUser(new UserDTO(null , "gosu",35, 3,"gosu@gmail.com","편의점 알바","1234","a","강남구","c",1.1,2,3,"ROLE_GOSU"));

...
//
//                //receiver가 접속해 있으면
//                WebSocketSession receiverSession = sessionsMap.get(receiver);
//
//                if ("chat".equals(cmd) && receiverSession != null){
//                    TextMessage tmpMsg = new TextMessage(sender + "님의 새로운 채팅!!");
//                    receiverSession.sendMessage(tmpMsg);
//                }
//
//                else if ("survey".equals(cmd) && receiverSession != null) {
//                    TextMessage tmpMsg = new TextMessage(sender + "님의 의뢰서 도착!!");
//                    receiverSession.sendMessage(tmpMsg);
//                }
//
//                else if ("quotation".equals(cmd) && receiverSession != null) {
//                    TextMessage tmpMsg = new TextMessage(sender + "님의 견적서 도착!!");
//                    receiverSession.sendMessage(tmpMsg);
//                }
//            }
//        }
...
////            sess.sendMessage(new TextMessage(sender + "님이 알림을 보냄"));
////        }
//    }
//
//    //소캣 연결 종료

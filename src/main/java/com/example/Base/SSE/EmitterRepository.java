...
public interface EmitterRepository {
    ...
    Map<String, SseEmitter> findAllEmitterStartWithByEmail(String email); //해당 회원과 같은 모든 Emitter를 찾는다
    Map<String, SseEmitter> findAllEmitterStartWithByEmailInList(List emails); //해당 회원과  관련된 모든 Emitter를 찾는다
